...
export default function StorySummaryIntroPage() {
        ...
        <div className="container mx-auto px-6 py-16 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-start text-left max-w-7xl mx-auto">
            <div>
              ...
              {language === "en"
                ? "Create concise memory cards from photos and simple time inputs."
                : "用相片同簡單時間輸入，就可以整出簡潔嘅記憶卡。"}
            </p>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-[2rem] p-8 border-2 border-emerald-100">
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-11 h-11 rounded-full bg-gradient-to-b from-emerald-500 to-green-600 text-white flex items-center justify-center font-bold text-lg shadow-lg">
                  1
                </div>
                <div>
